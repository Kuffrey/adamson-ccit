...
CREATE TABLE `admission_freshman_settings` (
  ...
  `how_to_apply` text,
  `initial_uploads` text,
  `requirements_shs` text,
  `requirements_als` text,
  `requirements_abroad` text,
  `enrollment_procedure` text,
  `sidebar_office` text,
  `sidebar_links` text,
...
CREATE TABLE `admission_graduate_settings` (
  ...
  `how_to_apply` text,
  `initial_uploads` text,
  `qualifications_masters` text,
  `qualifications_doctoral` text,
  `qualifications_jd` text,
  `requirements_enrollment` text,
  `enrollment_procedure` text,
  `sidebar_office` text,
  `sidebar_links` text,
  `sidebar_image_url` varchar(255) DEFAULT NULL,
