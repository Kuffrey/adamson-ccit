<?php
// app/models/StudentScholarshipsPageSettings.php
require_once __DIR__ . '/Model.php';
class StudentScholarshipsPageSettings extends Model {
    protected static $table = 'student_scholarships_page_settings';
    ...
    public static function updateSettings($data) {
        $db = self::db();
        $fields = ['subhero_image_url', 'subhero_lead', 'note'];
