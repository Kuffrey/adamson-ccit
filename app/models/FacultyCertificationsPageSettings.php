<?php
// app/models/FacultyCertificationsPageSettings.php
require_once __DIR__ . '/Model.php';
class FacultyCertificationsPageSettings extends Model {
    protected static $table = 'faculty_certifications_page_settings';
