<?php
// app/models/StudentOrganizationsPageSettings.php
require_once __DIR__ . '/Model.php';
class StudentOrganizationsPageSettings extends Model {
    protected static $table = 'student_organizations_page_settings';
