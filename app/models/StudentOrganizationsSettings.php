<?php
// app/models/StudentOrganizationsSettings.php
require_once __DIR__ . '/Model.php';
class StudentOrganizationsSettings extends Model {
    protected static $table = 'student_organizations_settings';
    ...
    public static function updateSettings($data) {
        $db = self::db();
        $fields = [
            'subhero_image_url', 'subhero_lead', 'orgs_grid'
        ];
