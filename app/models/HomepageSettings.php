...
final class HomepageSettings extends Model {
  ...
  public function update(array $d): bool {
    ...
    $fields = [
      ...
      'why_faculty_text','why_faculty_desc','why_faculty_link_label','why_faculty_link',
      'why_facilities_text','why_facilities_desc','why_facilities_link_label','why_facilities_link',
      'why_career_text','why_career_desc','why_career_link_label','why_career_link',
