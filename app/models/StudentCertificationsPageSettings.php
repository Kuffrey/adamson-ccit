<?php
// app/models/StudentCertificationsPageSettings.php
require_once __DIR__ . '/Model.php';
class StudentCertificationsPageSettings extends Model {
    protected static $table = 'student_certifications_page_settings';
    ...
    public static function updateSettings($data) {
        $db = self::db();
        $fields = ['subhero_image_url', 'subhero_lead', 'cstat_note', 'certs_note'];
