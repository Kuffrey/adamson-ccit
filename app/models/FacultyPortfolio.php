...
class FacultyPortfolio extends Model {
    protected static $table = 'faculty_201_file';

    // Migration helper: create the 201 file table if not exists
    public static function migrate201FileTable() {
        $pdo = self::db();
        $sql = "CREATE TABLE IF NOT EXISTS faculty_201_file (
