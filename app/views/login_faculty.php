...
<main>
  <section class="content" style="padding:20px 0">
    <div class="container">
      <h2>Login — Faculty CMS</h2>
      <?php if ($error): ?>
        <p style="color:red"><?= htmlspecialchars($error) ?></p>
      <?php endif; ?>
      <form method="post" action="/adamson-ccit/public/index.php?page=login_faculty" autocomplete="on">
        <label>Username:
      ...
      <p style="color:#6b7280;margin-top:8px">Faculty and admins access the CMS here.</p>
    </div>
  </section>
</main>
