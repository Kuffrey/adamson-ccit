...
if (isset($_POST['add_news'])) {
    try {
        ...
        if ($newsId) {
            ...
            try {
                FacultySubmissions::createFromNews($newsId, $faculty_id);
                $success_message = "News submitted for dean approval successfully!";
            } catch (Exception $e) {
                error_log("Failed to create submission for news: " . $e->getMessage());
                $error_message = "News created but failed to submit for approval.";
            }
        }
    } catch (Exception $e) {
        $error_message = "Failed to create news: " . $e->getMessage();
    }
    
    header('Location: ?page=faculty_manage_news');
    exit;
}
...
<head>
  ...
  <title>Submit News | Faculty Dashboard</title>
...
<div class="admin-cms-layout">
  ...
  <main class="admin-main">
    <header class="admin-topbar">
      <span class="admin-topbar__title">Submit News</span>
              ...
              <tbody>
                <?php foreach ($submittedNews as $item): ?>
                  <tr>
                    ...
                    <td>
                      <span class="category-tag"><?= esc($item['category'] ?? 'News') ?></span>
                    </td>
                    <td>
              ...
              <div class="modal-body">
                ...
                <div class="form-grid">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="content" name="content" rows="8" placeholder="Write your article content here..."></textarea>
                  </div>
