...
<head>
  ...
  <title>Edit Graduate School & JD Admission Page | Admin | AdU-CCIT</title>
  <link rel="stylesheet" href="/adamson-ccit/public/assets/css/admin-dashboard.css" />
</head>
<body>
<main class="admin-main">
  <section class="admin-section">
    <h1>Edit Graduate School & JD Admission Page</h1>
    ...
    <form method="post" class="admin-form" autocomplete="off">
      ...
      <label>Qualifications (Master's) (HTML allowed)
        <textarea name="qualifications_masters" rows="3"><?= e($settings['qualifications_masters'] ?? '') ?></textarea>
      </label>
      <label>Qualifications (Doctoral) (HTML allowed)
        <textarea name="qualifications_doctoral" rows="3"><?= e($settings['qualifications_doctoral'] ?? '') ?></textarea>
      </label>
      <label>Qualifications (JD) (HTML allowed)
        <textarea name="qualifications_jd" rows="3"><?= e($settings['qualifications_jd'] ?? '') ?></textarea>
      </label>
      <label>Requirements for Enrollment (HTML allowed)
        <textarea name="requirements_enrollment" rows="3"><?= e($settings['requirements_enrollment'] ?? '') ?></textarea>
      </label>
